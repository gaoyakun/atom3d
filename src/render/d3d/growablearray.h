#ifndef __ATOM_RENDER_GROWABLE_ARRAY_H
#define __ATOM_RENDER_GROWABLE_ARRAY_H
...
template<typename TYPE> HRESULT CGrowableArray <TYPE>::SetSizeInternal( int nNewMaxSize )
{
    ...
    else if( m_pData == NULL || nNewMaxSize > m_nMaxSize )
    {
        ...
        nNewMaxSize = ATOM_max2( nNewMaxSize, m_nMaxSize + nGrowBy );
...
#endif // __ATOM_RENDER_GROWABLE_ARRAY_H
