...
#ifndef ATOM_TINYXML_INCLUDED
#define ATOM_TINYXML_INCLUDED
...
#define TiXmlDocument ATOM_TiXmlDocument
#define TiXmlElement ATOM_TiXmlElement
#define TiXmlComment ATOM_TiXmlComment
#define TiXmlUnknown ATOM_TiXmlUnknown
#define TiXmlAttribute ATOM_TiXmlAttribute
#define TiXmlText ATOM_TiXmlText
#define TiXmlDeclaration ATOM_TiXmlDeclaration
#define TiXmlParsingData ATOM_TiXmlParsingData
...
class ATOM_KERNEL_API ATOM_TiXmlDocument;
class ATOM_KERNEL_API ATOM_TiXmlElement;
class ATOM_KERNEL_API ATOM_TiXmlComment;
class ATOM_KERNEL_API ATOM_TiXmlUnknown;
class ATOM_KERNEL_API ATOM_TiXmlAttribute;
class ATOM_KERNEL_API ATOM_TiXmlText;
class ATOM_KERNEL_API ATOM_TiXmlDeclaration;
class ATOM_KERNEL_API ATOM_TiXmlParsingData;
...
*/
class ATOM_KERNEL_API ATOM_TiXmlVisitor
{
public:
...
const ATOM_TiXmlEncoding ATOM_TIXML_DEFAULT_ENCODING = ATOM_TIXML_ENCODING_UNKNOWN;
...
/** ATOM_TiXmlBase is a base class for every class in TinyXml.
	...
	@endverbatim
*/
class ATOM_KERNEL_API ATOM_TiXmlBase
{
...
*/
class ATOM_KERNEL_API ATOM_TiXmlNode : public ATOM_TiXmlBase
{
	friend class ATOM_TiXmlDocument;
	friend class ATOM_TiXmlElement;
...
*/
class ATOM_KERNEL_API ATOM_TiXmlAttribute : public ATOM_TiXmlBase
{
...
*/
class ATOM_KERNEL_API ATOM_TiXmlAttributeSet
{
public:
...
*/
class ATOM_KERNEL_API ATOM_TiXmlElement : public ATOM_TiXmlNode
{
public:
	...
	*/
	...
	/** Convenience function for easy access to the text inside an element. Although easy
		...
		WARNING: GetText() accesses a child node - don't become confused with the 
				 similarly named ATOM_TiXmlHandle::Text() and ATOM_TiXmlNode::ToText() which are 
...
/**	An XML comment.
*/
class ATOM_KERNEL_API ATOM_TiXmlComment : public ATOM_TiXmlNode
{
public:
...
*/
class ATOM_KERNEL_API ATOM_TiXmlText : public ATOM_TiXmlNode
{
	friend class ATOM_TiXmlElement;
public:
...
*/
class ATOM_KERNEL_API ATOM_TiXmlDeclaration : public ATOM_TiXmlNode
{
public:
...
*/
class ATOM_KERNEL_API ATOM_TiXmlUnknown : public ATOM_TiXmlNode
{
public:
...
*/
class ATOM_KERNEL_API ATOM_TiXmlDocument : public ATOM_TiXmlNode
{
public:
	...
	*/
	bool LoadFile( ATOM_TiXmlEncoding encoding = ATOM_TIXML_DEFAULT_ENCODING );
	/// Save a file using the current document value. Returns true if successful.
	bool SaveFile() const;
	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename, ATOM_TiXmlEncoding encoding = ATOM_TIXML_DEFAULT_ENCODING );
	...
	*/
	bool LoadFile( FILE*, ATOM_TiXmlEncoding encoding = ATOM_TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( FILE* ) const;

	#ifdef TIXML_USE_STL
	bool LoadFile( const std::string& filename, ATOM_TiXmlEncoding encoding = ATOM_TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	virtual const char* Parse( const char* p, ATOM_TiXmlParsingData* data = 0, ATOM_TiXmlEncoding encoding = ATOM_TIXML_DEFAULT_ENCODING );
...
/**
	...
	@endverbatim
*/
class ATOM_KERNEL_API ATOM_TiXmlHandle
{
public:
	...
	*/
	...
	/** @deprecated use ToNode. 
		Return the handle as a ATOM_TiXmlNode. This may return null.
	*/
	ATOM_TiXmlNode* Node() const			{ return ToNode(); } 
	...
	*/
	...
	/**	@deprecated use ToText()
		Return the handle as a ATOM_TiXmlText. This may return null.
	*/
	ATOM_TiXmlText* Text() const			{ return ToText(); }
...
/** Print to memory functionality. The ATOM_TiXmlPrinter is useful when you need to:
	...
	ATOM_TiXmlPrinter uses the Visitor API.
	@verbatim
	ATOM_TiXmlPrinter printer;
	printer.SetIndent( "\t" );
	...
	@endverbatim
*/
class ATOM_KERNEL_API ATOM_TiXmlPrinter : public ATOM_TiXmlVisitor
{
public:
...
/*
ATOM_KERNEL_API ATOM_MemoryPool * ATOM_CALL ATOM_GetMemoryPool(void);

#define ATOM_TIXML_DECLARE_POOL_TYPE(type) \
template <>	\
struct ATOM_MallocTraits<type>	\
{	\
	void * alloc(unsigned size, unsigned align, const char *filename, unsigned lineno)	\
	{	\
		return ATOM_GetMemoryPool()->aligned_alloc(size, align);	\
	}	\
	void dealloc(void *p, const char *filename, unsigned lineno)	\
	{	\
		return ATOM_GetMemoryPool()->aligned_dealloc(p);	\
	}	\
};

ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlBase)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlAttributeSet)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlNode)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlDocument)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlElement)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlComment)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlUnknown)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlAttribute)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlText)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlDeclaration)
ATOM_TIXML_DECLARE_POOL_TYPE(ATOM_TiXmlParsingData)
*/
