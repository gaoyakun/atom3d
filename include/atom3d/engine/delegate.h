...
#ifndef ATOM3D_FLASH_DELEGATE_H
#define ATOM3D_FLASH_DELEGATE_H
...
#undef FASTDELEGATE_USESTATICFUNCTIONHACK
	...
	typedef FastDelegate2<FlashControl*, const ATOM_FlashArguments&, ATOM_FlashValue> FlashDelegate;

#endif // ATOM3D_FLASH_DELEGATE_H
