#ifndef __ATOM3D_RENDER_SHADER_H
#define __ATOM3D_RENDER_SHADER_H
...
public:
	...
	//--- wangjian modified ---//
	virtual bool create (const char *source, const char *entryPoint, int shaderCompileTarget, bool createFromBin = false, ATOM_File * binFile = 0 ) = 0;
	//-------------------------//
	...
	virtual bool getParamDesc (ParamHandle param, ParamDesc *desc) = 0;
};

#endif // __ATOM3D_RENDER_SHADER_H
