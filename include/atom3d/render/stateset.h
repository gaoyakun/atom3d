#ifndef __ATOM3D_RENDER_RENDERSTATES_H
#define __ATOM3D_RENDER_RENDERSTATES_H
...
public:
	...
	enum SamplerFilter
	{
		...
		SamplerFilter_LLL,
		SamplerFilter_LLN,
		SamplerFilter_AnisotropicL,
		SamplerFilter_AnisotropicP,
		SamplerFilter_AnisotropicN,
		SamplerFilter_Count
	};
	...
	enum
	{
		PixelSamplerCount = 16,
		VertexSamplerCount = 4,
		SamplerCount = PixelSamplerCount + VertexSamplerCount
	};

	// Displacement map stage index
	enum
	{
		DMapStage_0 = PixelSamplerCount,
		DMapStage_1,
		DMapStage_2,
		DMapStage_3
	};
...
public:
	...
	virtual void setMaxLOD (float val) = 0;
	virtual float getMaxLOD (void) const = 0;
...
public:
	...
	virtual void setDevice (ATOM_RenderDevice *device) = 0;
	virtual ATOM_RenderDevice *getDevice (void) const = 0;
};

#endif // __ATOM3D_RENDER_RENDERSTATES_H
