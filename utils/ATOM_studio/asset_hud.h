#ifndef __ATOM3D_STUDIO_ASSET_HUD_H
#define __ATOM3D_STUDIO_ASSET_HUD_H

#if _MSC_VER > 1000
# pragma once
#endif

class AssetHud: public AS_Asset
{
public:
	AssetHud (void);
...
private:
	ATOM_AUTOREF(ATOM_Hud) _hudNode;
};

class HudAssetManager: public AS_AssetManager
{
public:
...
#endif // __ATOM3D_STUDIO_ASSET_HUD_H
