#ifndef __ATOM3D_STUDIO_ASSET_LIGHT_H
#define __ATOM3D_STUDIO_ASSET_LIGHT_H

#if _MSC_VER > 1000
# pragma once
#endif

class AssetLight: public AS_Asset
{
public:
	AssetLight (void);
...
private:
	void create (ATOM_Light::LightType type);

private:
	ATOM_AUTOREF(ATOM_LightNode) _lightNode;
};

class LightAssetManager: public AS_AssetManager
{
public:
...
#endif // __ATOM3D_STUDIO_ASSET_LIGHT_H
