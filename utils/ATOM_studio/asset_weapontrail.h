#ifndef __ATOM3D_STUDIO_ASSET_WEAPONTRAIL_H
#define __ATOM3D_STUDIO_ASSET_WEAPONTRAIL_H

#if _MSC_VER > 1000
# pragma once
#endif

class AssetWeaponTrail: public AS_Asset
{
public:
	AssetWeaponTrail (void);
...
private:
	ATOM_AUTOREF(ATOM_WeaponTrail) _trailNode;
};

class WeaponTrailAssetManager: public AS_AssetManager
{
public:
...
#endif // __ATOM3D_STUDIO_ASSET_WEAPONTRAIL_H
